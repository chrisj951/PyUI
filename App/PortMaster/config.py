...
elif Path("/mnt/SDCARD/pyui").is_dir():
    ## PyUI (Miyoo Flip)
    HM_DEFAULT_TOOLS_DIR   = Path("/mnt/SDCARD/App/PortMaster/portmaster")
    HM_DEFAULT_PORTS_DIR   = Path("/mnt/SDCARD/Roms/PM")
    HM_DEFAULT_SCRIPTS_DIR = Path("/mnt/SDCARD/Roms/PM")
